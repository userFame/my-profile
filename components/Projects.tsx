      ...
      <div className="wrap py-14 sm:py-20 md:py-24">
        ...
        >
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold leading-tight mb-6">
            Selected
            <br />
            <span className="font-extralight italic text-[#E35336]">work</span>
          </h2>
              ...
              <button
                ...
                className={`text-[11px] uppercase tracking-wider px-3 py-1.5 rounded-sm border transition-all duration-200 font-medium whitespace-nowrap ${
                  active === f
                    ...
                    : "border-[#EAC8B0] text-[#9988A1] hover:border-[#2A0E06] hover:text-[#2A0E06]"
                }`}
              >
                {f}
              </button>
            ...
            >
              ...
              <div className="flex items-start justify-between gap-4">
                <div className="flex items-baseline gap-3 sm:gap-5 min-w-0">
                  <span className="text-xs tabular-nums text-[#9988A1] shrink-0 w-9 sm:w-10">{p.year}</span>
                  <div className="min-w-0">
                    ...
                    <p className="text-sm text-[#9988A1] leading-relaxed mt-1.5 max-w-2xl">
                      {p.description}
                    </p>
                    {/* Tech chips */}
                ...
                <div className="shrink-0 mt-1">
                  {p.link ? (
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="flex items-center gap-1 text-xs text-[#9988A1] hover:text-[#2A0E06] transition-colors font-medium uppercase tracking-wider"
                    ...
                    <span className="text-xs text-[#EAC8B0] uppercase tracking-wider hidden sm:inline">
                      Private
                    </span>
                  )}
                </div>
